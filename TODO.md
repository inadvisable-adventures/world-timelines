...
7. Add to the QLever SPARQL query (from TODO item 6) a requirement that every returned entry has an associated Wikipedia page, and store that page name in the appropriate place in the entry. [planned: qlever-require-wikipedia-page.md]
