...
8. Exclude sports figures from the QLever `person` category query, generally rather than by enumerating individual sports. [planned: qlever-exclude-sports-figures.md]
