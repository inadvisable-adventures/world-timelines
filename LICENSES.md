...
| Source | License | Notes |
|---|---|---|
| **Cliopatria** (Seshat Global History Databank — political boundaries) | CC BY 4.0 | Top pick for boundaries; attribution required on use. |
...
| **HMS Beagle voyage GeoJSON** (ClimateViewer — journey path) | **CC BY-NC-SA 4.0** | Non-commercial restriction; fine for this hobby project as long as it stays non-commercial. |
